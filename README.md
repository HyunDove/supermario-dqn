...
### 🏆 EP 10000 · 1-1 스테이지 클리어

> **총 10,000 에피소드(1,593,659 스텝) 학습 결과, EP 10000에서 슈퍼마리오 1-1 스테이지 클리어를 달성하였습니다.**

픽셀(84×84 흑백 화면)만을 입력으로 받는 CNN DQN 에이전트가 별도의 사전 지식 없이 보상 신호만을 통해 스테이지를 완주한 결과입니다.
...
| EP 2000 | 269,649 | 860.7 | 2,874.0 | 초기 학습 — 우측 전진 패턴 발견 |
| EP 5000 | 686,248 | 1,222.6 | 3,059.0 | 중기 — 장애물 회피 학습 |
| EP 7000 | 1,019,666 | 1,387.2 | 3,059.0 | 후기 — 전진 전략 고도화 |
| **EP 10000** | 1,593,659 | 1,590.0 | 3,062.0 | **🏆 1-1 스테이지 클리어 달성** |

### 향후 발전 방향

| 기법 | 기대 효과 |
|---|---|
| **Double DQN** | Q값 과대추정 억제 → 학습 안정화 |
| **Prioritized Experience Replay** | 중요 경험 우선 학습 → 샘플 효율 향상 |
| **다중 스테이지 학습** | 1-2, 1-3 등 추가 스테이지 → 일반화 능력 확장 |
...
| 📈 **학습 성과** | 전체 학습 곡선(10,000 에피소드) + 체크포인트별 성능 비교 표 |
