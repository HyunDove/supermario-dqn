...
| EP 10000 | *(기입 예정)* | 0.1000 | *(기입 예정)* | *(기입 예정)* | *(기입 예정)* | *(기입 예정)* |

**주요 관찰:**
- ε은 EP 2000 이전(약 230,000 스텝)에 이미 최솟값 0.1에 도달 — 이후 전 구간 활용(exploitation) 위주로 학습
- 100회 이동 평균 보상이 EP 0(592) → EP 7000(1,387)로 약 **2.3배** 향상
- EP 5000~7000 구간에서 최고 보상(3,059)이 수렴하는 양상 — 현재 DQN 구조의 성능 상한에 근접 중
