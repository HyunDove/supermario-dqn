...
| 총 에피소드 | 7,000 (200 에피소드마다 체크포인트 저장) |
...
![EP1000 학습 곡선](../results/curve_ep1000.png)
...
| EP 1000 | `mario_ep1000.mp4` | 우측 전진 행동 학습 시작 |
| EP 5000 | `mario_ep5000.mp4` | 장애물 회피 패턴 등장 |
| EP 7000 | `mario_ep7000.mp4` | 학습된 전략으로 최대 전진 |
...
| 🎬 **에피소드 비교** | EP 0/1000/5000/7000 플레이 영상 4개 나란히 비교 |
...
| 녹화 | `src/utils/recorder.py` | 에피소드 플레이 MP4 녹화 |
| 학습 노트북 | `colab/train.ipynb` | Colab T4 GPU 학습 + 체크포인트 그래프 자동 저장 |
...
- GPU 가속 환경에서 더 많은 에피소드(10,000+)를 학습하면 클리어 가능성이 높아진다.
